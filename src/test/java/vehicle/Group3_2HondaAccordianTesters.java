...
public class Group3_2HondaAccordianTesters {
    ...
    public void hondaTest1() {
        ...
        // remainingRange
        assertEquals(honda1.getRemainingRange(), honda1.getMPG() * honda1.getFuelLevel());
        assertEquals(honda2.getRemainingRange(), honda2.getMPG() * honda2.getFuelLevel());
        ...
        // fuelLevel
        assertEquals(honda1.getFuelLevel(), 0);
        assertEquals(honda2.getFuelLevel(), 0);

        // mileage
        assertEquals(honda1.getMileage(), honda1.getFuelCapacity() * honda1.getMPG() + 3);
        assertEquals(honda2.getMileage(), honda2.getFuelCapacity() * honda2.getMPG() + 53);
